...
@Component
public class RockerBuilderPlugin implements JRocksPlugin {

  static final String LAYOUT_QUALIFIER = "RockerBuilderPlugin";
  ...
  @Autowired
  public RockerBuilderPlugin(@Qualifier(LAYOUT_QUALIFIER) List<PluginGenerator> generators) {
    this.generators = generators;
  }

  @Override
  public String name() {
    return "builder-rocker";
  }
