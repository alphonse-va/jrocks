...
public class ReflectiveEntityClassInfo extends ClassGraphClassInfo implements EntityClassInfo {
  ...
  public ReflectiveEntityClassInfo(ClassInfo beanClass, ReflectiveClassInfo idClass) {
    super(beanClass);
